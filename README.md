...
Variables:
- `VITE_API_BASE_URL` (optional; when empty, frontend uses `/api` in local dev and same-origin in deployments. Avoid setting this to `http://localhost:8080` on HTTPS/deployed frontends.)
