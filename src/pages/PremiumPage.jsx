...
const getCatalog = ({ monthlyPlan, yearlyPlan, billingCycle, yearlySavingsLabel, currency }) => [
  {
    ...
    benefits: [
      ...
      "Up to 50 topics and subtopics per sheet",
      "Up to 5 total sheets",
      "Create, delete, and publish sheets",
  ...
  },
  {
    ...
    benefits: [
      "Custom revision alerts",
      "Progress insights",
      "Advanced question completion options (duration, error tracking, and more)",
      "Analytics-ready tracking",
      "No limits on questions, topics, and subtopics per sheet",
      "Unlimited sheets",
    ],
    ctaLabel: "Start Pro",
