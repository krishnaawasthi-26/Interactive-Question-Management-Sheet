...
function ReminderNotificationCenter() {
  ...
  return (
    <div className="pointer-events-none fixed right-4 top-[calc(env(safe-area-inset-top)+5rem)] sm:top-[calc(env(safe-area-inset-top)+5.5rem)] z-[2147483647] w-[min(92vw,420px)] space-y-3">
